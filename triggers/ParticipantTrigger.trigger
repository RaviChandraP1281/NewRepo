/**
* ─────────────────────────────────────────────────────────────────────────────────────────────────┐
* Master trigger for the "Participants" object (API Name: Participants__c).
*
...
* @see          ParticipantTriggerHandler.class
* @see          Participants__c.object
* ──────────────────────────────────────────────────────────────────────────────────────────────────
* @changes
...
* ─────────────────────────────────────────────────────────────────────────────────────────────────┘
*/
trigger ParticipantTrigger on Participants__c (before insert, before update, before delete, 
  ...
  //───────────────────────────────────────────────────────────────────────────┘
  ParticipantTriggerHandler handler = new ParticipantTriggerHandler(trigger.size);
